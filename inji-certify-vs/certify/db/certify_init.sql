...
INSERT INTO certify.credential_config (
    ...
    NULL, NULL,
    -- context + credential_type stored ALPHABETICALLY SORTED: the signing-time config lookup
    -- builds its cache key from the sorted request types/contexts, so the stored key must match.
    'https://w3id.org/security/suites/ed25519-2020/v1,https://www.w3.org/2018/credentials/v1,https://www.w3.org/ns/credentials/examples/v2',
    'FoundationalResidentID,VerifiableCredential,VerifiableTrustCredential',
    'ldp_vc',
